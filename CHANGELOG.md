...
- <kbd>Fix:</kbd> show byte sizes and size changes for files marked binary or -text in .gitattributes. <!-- client 7906 -->
- <kbd>Fix:</kbd> don't jump to an unrelated file when marking a file reviewed and advancing. <!-- client 7906 -->
- <kbd>Upd:</kbd> Truncate file names and avatars in narrow sidebar file matrix. <!-- client 7906 -->
