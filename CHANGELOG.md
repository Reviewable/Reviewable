...
- <kbd>New:</kbd> Introduce [publish on push](https://docs.reviewable.io/reviews#publish-on-push) workflow.  <!-- client -->
  ...
  >
  > Prefer the old behavior? No problem — just uncheck the *Publish on push* setting in the publish options to have your drafts published immediately instead. This setting is saved globally for your accoun
