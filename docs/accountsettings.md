...
1. Download and execute it directly with `npx reviewable@latest`.  This has the advantage of always using the latest version but carries some extra overhead each time you invoke it.
