...
3. If, on the other hand, you're an admin setting up Reviewable for the first time, you'll want to jump to the [Admin Center](admincenter.md) section first for details on how to connect repos and start a subscription (if necessary).
...
The changelog (**Support > Changelog**) always has the latest on features and bug fixes.  Check out our [blog](https://www.reviewable.io/blog/) for feature deep dives and developer stories.  For the truly dedicated, you can watch the [Reviewable/Reviewable](https://github.com/reviewable/reviewable) repo for new issues and updates to these docs.
