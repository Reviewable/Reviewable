...
Below these buttons you will find a sidebar showing a list of files that are pending review. Click the file name to jump directly to that file in the main review panel.
