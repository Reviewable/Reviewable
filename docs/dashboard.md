...
::: tip
By default, the dashboard also includes up to ten PRs closed or merged in the last three days, selected by most recent update. Use `+open,draft,queued` to hide them, or **Show more concluded reviews** to expand the time window and remove the count limit.
:::
