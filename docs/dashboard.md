...
Your own files contribute to `+red` only after you [start self-reviewing](reviews.md#user-roles), including with a draft mark. Author files never match `+deferred`.
