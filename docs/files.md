...
#### Diff suppression and syntax highlighting
...
!> Be careful if you’re trying to use `ctrl-f` to find something in the diffs when some are not shown.
...
### Forked repos that track upstream changes
