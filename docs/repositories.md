...
{:.important}
Reviewable reads the contents of the `.reviewable` directory from the repository's default branch. This is unless changed on GitHub your `main` or `master` branch. The contents of other branches don't effect the repository settings, until they get merged into the default branch.
