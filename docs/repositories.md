...
* **Requested** - only show the badge once a review has been requested. That excludes any PR that never left the draft status, since no review is requested for draft PRs.
