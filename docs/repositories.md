...
If you wish to manage all repo settings in one central place without allowing the master settings to overridden by local settings, you can set `final: true` in the master settings which in turn causes any local settings to be ignored.
