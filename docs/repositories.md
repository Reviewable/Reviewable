...
By default the badge is added when the PR is created. If you have a current Reviewable subscription or trial, you may optionally choose when to show the badge:
