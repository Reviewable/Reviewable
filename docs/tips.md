...
2. Use a custom review completion condition to [identify files as vendored](https://github.com/Reviewable/Reviewable/blob/master/examples/conditions/ignore_system_files.js) in the file matrix, which will allow you to mark them all as reviewed with one click.
