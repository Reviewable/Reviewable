...
When you use Reviewable, you may be given access to lots of additional products and features ("Additional Products and Features"). Because many of the Additional Products and Features offer different functionality, your Agreement with us (as defined in the Reviewable [Terms of Service](terms.md)) includes specific terms for that product or feature that may apply in addition to your main agreement with us (the Reviewable [Terms of Service](terms.md)). Below, we've listed those products and features, along with the corresponding additional terms that apply to your use of them.
