...
The status of a review was updated for some reason.  This event is not user-specific and will be triggered every time any of the properties below changes for a review.
```
{
  owner: string,
  repo: string,
