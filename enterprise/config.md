...
* `REVIEWABLE_API_SECRET`: A secret token (ASCII only) used to authentificate requests to the [REST API](https://github.com/Reviewable/Reviewable/blob/master/enterprise/api.md). If unset the REST API will be disabled.
