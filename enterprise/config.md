...
In order to connect you Reviewable Enterprise instance to your Slack workspace (enabling review updates via Slack, sync handles, etc.), please follow these steps:
...
8. Click the "Install to ..." button under "OAuth Tokens" and authorize the app.
9. Copy the "Bot User OAuth Token" and configure it via the `REVIEWABLE_BOT_TOKEN` environment variable.
