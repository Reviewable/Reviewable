...
Next, on your GitHub instance, find the settings section of your preferred organization — any one will do.  In the OAuth applications subsection click the Register new application button:
