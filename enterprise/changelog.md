...
- New: added REVIEWABLE_LOG_GITHUB_API_LATENCY,  REVIEWABLE_GITHUB_CACHE_SIZE, and REVIEWABLE_IGNORE_TRUNCATED_SUBTREES environment variables.  See [configuration docs](https://github.com/Reviewable/Reviewable/blob/master/enterprise/config.md) for details.
