...
- Upd: Supporting validation of `x-hub-signature-256` in webhook requests.
- Upd: Respecting prefers-reduced-motion setting when Animated transitions setting not manually set.
...
- Fix: The 'View on github' hashed path was updated from md5 to SHA-256 and now links to the correct file.
- Fix: Link to an image left in a comment opens in new tab.
